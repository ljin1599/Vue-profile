...
<template>
  ...
  <el-form ref="ruleFormRef" :model="ruleForm" :rules="rules" label-width="120px">
    ...
    <el-form-item label="Phone number" prop="phnum">
      <el-input v-model="ruleForm.phnum" placeholder="Please input"></el-input>
    </el-form-item>
    <!-- 이메일 -->
    ...
    <!-- btn -->
    <el-form-item>
      <router-link to="/readabout"><el-button id="btn" v-if="num" @click="updateForm(ruleFormRef)">update</el-button></router-link>
      <router-link to="/readabout"><el-button id="btn" v-if ="!num" type="primary" @click="[submitForm(ruleFormRef)]">Submit</el-button></router-link>

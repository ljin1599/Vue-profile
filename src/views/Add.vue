...
<!-- 추가된 학력사항 -->
<!--
    <el-form-item v-for="(edu, index) in plusedu.edui" :key="index" 
      :prop="'edui.' + index + '.value'" :rules="{ message: 'edu can not be null', trigger: 'blur' }">
      <el-input v-model="edu.value" props:neweduinput />
      <el-button class="mt-2" @click.prevent="removeedu(edu)">Delete</el-button>
    </el-form-item>
    -->
<!-- 버튼 -->
    <el-form-item>
